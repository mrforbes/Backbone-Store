...
Lawnchair.adapter('window-name', (function(index, store) {
    ...
    var data = window.top.name.match(/{/i) ? JSON.parse(window.top.name) : {}
	//if(data.match(/{/)!=null) data = JSON.parse(window.top.name)
    return {
...
define('libs/lawnchair',[],function(){return Lawnchair})